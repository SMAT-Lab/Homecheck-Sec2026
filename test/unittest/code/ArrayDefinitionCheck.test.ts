...
import { ArrayDefinitionCheck } from '../../../src/checker/performance/ArrayDefinitionCheck';
...
beforeAll(async () => {
    ...
    checkEntry = await testCaseCheck('./test/unittest/sample/ArrayDefinition', rule, CHECK_MODE.FILE2CHECK, ArrayDefinitionCheck);
...
describe('ArrayDefinitionCheckTest', () => {
    ...
    test('ArrayDefinitionCheckTest_002', () => {
        ...
        const expectReportList = ['16%11%24%', '17%11%24'];
