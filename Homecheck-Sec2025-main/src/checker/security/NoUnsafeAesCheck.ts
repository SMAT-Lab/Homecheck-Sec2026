...
const logger = Logger.getLogger(LOG_MODULE_TYPE.HOMECHECK, 'NoUnsafeAesCheck');
...
const creatCipherSignature = `@ohosSdk/api/@ohos.security.cryptoFramework.d.ts: cryptoFramework.${DEFAULT_ARK_CLASS_NAME}.createCipher(string)`;

export class NoUnsafeAesCheck implements BaseChecker {
