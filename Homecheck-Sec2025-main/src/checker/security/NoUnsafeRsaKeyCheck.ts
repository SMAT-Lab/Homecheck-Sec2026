...
const logger = Logger.getLogger(LOG_MODULE_TYPE.HOMECHECK, 'NoUnsafeRsaKeyCheck');
...
const createAsyKeyGeneratorSignature = `@ohosSdk/api/@ohos.security.cryptoFramework.d.ts: cryptoFramework.${DEFAULT_ARK_CLASS_NAME}.createAsyKeyGenerator(string)`;

export class NoUnsafeRsaKeyCheck implements BaseChecker {
