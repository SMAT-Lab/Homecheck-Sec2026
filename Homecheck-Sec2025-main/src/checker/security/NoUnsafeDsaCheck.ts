...
const logger = Logger.getLogger(LOG_MODULE_TYPE.HOMECHECK, 'NoUnsafeDsaCheck');
...
const createSignature: string[] = [
    `@ohosSdk/api/@ohos.security.cryptoFramework.d.ts: cryptoFramework.${DEFAULT_ARK_CLASS_NAME}.createSign(string)`,
    `@ohosSdk/api/@ohos.security.cryptoFramework.d.ts: cryptoFramework.${DEFAULT_ARK_CLASS_NAME}.createVerify(string)`
];

export class NoUnsafeDsaCheck implements BaseChecker {
