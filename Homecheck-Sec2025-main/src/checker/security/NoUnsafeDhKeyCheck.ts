...
const logger = Logger.getLogger(LOG_MODULE_TYPE.HOMECHECK, 'NoUnsafeDhKeyCheck');
...
const creatCipherSignature = `@ohosSdk/api/@ohos.security.cryptoFramework.d.ts: cryptoFramework.${DEFAULT_ARK_CLASS_NAME}.createAsyKeyGenerator(string)`;

export class NoUnsafeDhKeyCheck implements BaseChecker {
