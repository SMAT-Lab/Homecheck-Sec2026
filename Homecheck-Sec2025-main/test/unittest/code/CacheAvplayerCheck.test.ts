...
import { CacheAvplayerCheck } from '../../../src/checker/performance/CacheAvplayerCheck';
...
beforeAll(async () => {
    ...
    checkEntry = await testCaseCheck('./test/unittest/sample/CacheAvplayer', rule, CHECK_MODE.FILE2CHECK, CacheAvplayerCheck);
...
describe(' CacheAvplayerTest', () => {
    test(' CacheAvplayerTest_001', () => {
        ...
        const expectReportList = ['18%21%27%'];
