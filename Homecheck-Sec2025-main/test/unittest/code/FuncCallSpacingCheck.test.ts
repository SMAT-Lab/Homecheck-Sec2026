...
import { FuncCallSpacingCheck } from "../../../src/checker/ArkTS-eslint/FuncCallSpacingCheck";
...
beforeAll(async () => {
  ...
  checkEntry = await testCaseCheck(
    "./test/unittest/sample/FuncCallSpacing",
    rule,
...
describe("FuncCallSpacingCheckTest", () => {
   ...
   */
  test("FuncCallSpacingCheckTest_002", () => {
