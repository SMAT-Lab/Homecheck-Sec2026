...
const logger = Logger.getLogger(LOG_MODULE_TYPE.HOMECHECK, 'WeakRandomCheck');

const gMetaData: BaseMetaData = {
    severity: 1,
    ruleDocPath: '',
    description: 'Detects use of Math.random() for security-sensitive tokens.'
};

export class WeakRandomCheck implements BaseChecker {
