...
const logger = Logger.getLogger(LOG_MODULE_TYPE.HOMECHECK, 'CommandInjectionCheck');

const gMetaData: BaseMetaData = {
    severity: 2,
    ruleDocPath: '',
    description: 'Detects potential command injection vulnerabilities via exec() calls with user input.'
};

export class CommandInjectionCheck implements BaseChecker {
