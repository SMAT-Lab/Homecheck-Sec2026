import {ArkFile, ArkStaticInvokeExpr, Stmt} from 'arkanalyzer';
...
const gMetaData: BaseMetaData = {
    severity: 2,
    ruleDocPath: '',
    description: 'Detects SQL injection vulnerability via string concatenation in SQL queries.'
};
            ...
            for (const arkMethod of arkClass.getMethods()) {
                ...
                for (const stmt of cfg.getStmts()) {
                    ...
                    if (text.includes('select') || text.includes('insert') || 
                        ...
                        text.includes('drop') || text.includes('create') ||
                        text.includes('execute') || text.includes('query')) {
