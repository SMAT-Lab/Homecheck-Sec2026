...
const gMetaData: BaseMetaData = {
    severity: 2,
    ruleDocPath: '',
    description: 'Detects XSS vulnerability via unsafe HTML/JS string handling.'
};
            ...
            for (const arkMethod of arkClass.getMethods()) {
                ...
                for (const stmt of cfg.getStmts()) {
                    ...
                    if ((text.includes('innerhtml') || text.includes('outerhtml') ||
                        text.includes('document.write') || text.includes('eval') ||
                        text.includes('setattribute') || text.includes('createelement')) &&
