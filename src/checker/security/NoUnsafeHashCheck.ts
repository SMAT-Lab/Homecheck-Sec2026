...
const logger = Logger.getLogger(LOG_MODULE_TYPE.HOMECHECK, 'NoUnsafeHashCheck');
...
const createMdSignature = `@ohosSdk/api/@ohos.security.cryptoFramework.d.ts: cryptoFramework.${DEFAULT_ARK_CLASS_NAME}.createMd(string)`;

export class NoUnsafeHashCheck implements BaseChecker {
