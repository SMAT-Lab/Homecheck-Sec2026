...
const logger = Logger.getLogger(LOG_MODULE_TYPE.HOMECHECK, 'NoUnsafeRsaEncryptCheck');
...
const createCipherSignature = `@ohosSdk/api/@ohos.security.cryptoFramework.d.ts: cryptoFramework.${DEFAULT_ARK_CLASS_NAME}.createCipher(string)`;

export class NoUnsafeRsaEncryptCheck implements BaseChecker {
