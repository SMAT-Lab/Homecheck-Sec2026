...
export class Utils {
     ...
     * @param logPath 日志路径
     */
    static setLogPath(logPath: string, arkLogLevel: LOG_LEVEL = LOG_LEVEL.ERROR,
        hcLogLevel: LOG_LEVEL = LOG_LEVEL.INFO): void {
        Logger.configure(logPath, arkLogLevel, hcLogLevel);
    }
