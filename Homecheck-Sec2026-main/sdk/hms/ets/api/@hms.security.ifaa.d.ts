...
declare namespace ifaa {
    /**
      * Get ifaa version.
      *
      * @returns { number } the anonymized deviceId.
      * @syscap SystemCapability.Security.Ifaa
      * @since 4.1.0(11)
      */
    /**
    ...
    /**
      ...
      *
      * @param { Uint8Array } userToken - user token allocated by the ifaa alliance.
      * @returns { boolean } the promise used to return the enabling status of the IFAA.
      * @throws { BusinessError } 401 - Parameter error.
      * @throws { BusinessError } 1006100001 - System Interruption.
      * @throws { BusinessError } 1006100002 - The service is abnormal.
      * @syscap SystemCapability.Security.Ifaa
    ...
    /**
      ...
      *
      * @param { Uint8Array } registerData - Data required for enabling the IFAA feature.
    ...
    /**
      ...
      * @returns { Uint8Array } the promise used to return the result of authentication.
      * @throws { BusinessError } 401 - Parameter error.
      * @throws { BusinessError } 1006100001 - System Interruption.
      * @throws { BusinessError } 1006100002 - The service is abnormal.
      * @syscap SystemCapability.Security.Ifaa
