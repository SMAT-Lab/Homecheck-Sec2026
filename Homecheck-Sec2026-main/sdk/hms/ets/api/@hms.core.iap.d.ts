...
declare namespace iap {
    ...
    interface PurchaseParameter {
        ...
        reservedInfo?: string;
        /**
         * The promotional offer id for this purchase.
         *
         * @type { ?string }
         * @syscap SystemCapability.Payment.IAP
         * @stagemodelonly
        ...
        /**
         * An obfuscated string that associates the purchase with a user account on your service.
         *
         * @type { ?string }
         * @syscap SystemCapability.Payment.IAP
         * @stagemodelonly
        ...
        /**
         * Signed purchase parameter like promotional offer etc, in JWS compact serialization format.
         *
         * @type { ?string }
         * @syscap SystemCapability.Payment.IAP
         * @stagemodelonly
     ...
     * @throws { BusinessError } 1001860054 - The country or region of the signed-in HUAWEI ID does not support IAP.
     * @throws { BusinessError } 1001860056 - The user is not allowed to make purchase.
     * @throws { BusinessError } 1001860059 - Invalid promotional offer id.
     * @throws { BusinessError } 1001860060 - Invalid purchase signature.
     * @syscap SystemCapability.Payment.IAP
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.0(12)
    ...
    enum IAPErrorCode {
         ...
         * @since 5.0.0(12)
         */
        INVALID_PROMOTIONAL_OFFER = 1001860059,
        /**
         ...
         * @since 5.0.0(12)
         */
        INVALID_PURCHASE_SIGNATURE = 1001860060
    }
}
export default iap;
