...
declare namespace gamePerformance {
    ...
    interface ThermalInfo {
        /**
         * Thermal margin, provides an estimate of the thermal margin the device will have before it reaches the threshold.
    ...
    /**
     * Enumerates the device info type.
     *
     * @enum { number }
     * @syscap SystemCapability.GameService.GamePerformance
     * @since 5.0.1(13)
    ...
    /**
     * Subscribes device state change events with specified device information type.
     *
     * @param { 'deviceStateChanged' } type - Type of the event to listen for.
     * @param { Callback<DeviceInfo> } callback - Callback is invoked when the event is triggered.
     * @param { Array<DeviceInfoType> } scope - Set of device information types.
     * @throws { BusinessError } 401 - The parameter check failed.
     * @throws { BusinessError } 1010300003 - Invalid request.
     * @syscap SystemCapability.GameService.GamePerformance
     * @since 5.0.1(13)
    ...
    interface DeviceInfoParameter {
        ...
        /**
         * Parameters for different device info type. For thermal parameters, "tempLevel" is optional.
         *
    ...
    /**
     * Enumerates the device info parameter key.
     *
     * @enum { string }
     * @syscap SystemCapability.GameService.GamePerformance
     * @since 5.0.1(13)
     */
    enum DeviceInfoParameterKey {
        /**
         * Temperature level. The value ranges from 1 to 6.
         *
         * @syscap SystemCapability.GameService.GamePerformance
         * @since 5.0.1(13)
         */
        THERMAL_TEMP_LEVEL = 'tempLevel'
    }
    /**
     * Get device information by specified device information type and parameters.
     *
     * @param { Array<DeviceInfoParameter> } scope - Set of device information types and parameters.
     * @returns { Promise<DeviceInfo> } Returns device information in the selected scope.
     * @throws { BusinessError } 401 - The parameter check failed.
     * @throws { BusinessError } 1010300003 - Invalid request.
     * @syscap SystemCapability.GameService.GamePerformance
     * @since 5.0.1(13)
     */
    function getDeviceInfoByScope(scope: Array<DeviceInfoParameter>): Promise<DeviceInfo>;
}
