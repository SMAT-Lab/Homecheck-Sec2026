...
declare namespace rcp {
     ...
     * @param { Request } request - The type of the parameter is an HTTP request.
     * @param { Path } suggestedPath - The path in the request.
     * @returns { TargetFile | Promise<TargetFile> }
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 5.0.0(12)
     */
     ...
     * @param { ArrayBuffer } incomingData - The data that needs to be processed
     * @returns { void | Promise<void> } Return void | Promise<void>.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 5.0.0(12)
     */
    ...
    export class UploadFromFile {
        ...
        /**
         * Constructor.
         * @param { Path | LocalFile | ReadFile } fileOrPath - The path you want to upload.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.0.0(12)
         */
    ...
    export class UploadFromStream {
        ...
        /**
         * Constructor.
         * @param { Stream | ReadStream | SyncReadStream } stream - Something like a stream
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.0.0(12)
         */
     ...
     * @typedef NetworkOutputQueueConstructor
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 5.0.0(12)
     */
     ...
     * @typedef NetworkInputQueueConstructor
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 5.0.0(12)
     */
    export interface NetworkInputQueueConstructor {
         ...
         * @param { number } maxSize - maximum queue size to use
         * @param { SendingPausePolicy } pausePolicyOverride pause policy settings for sending.
         * @returns { INetworkInputQueue } Return a {@link INetworkInputQueue} object.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.0.0(12)
         */
    ...
    /**
     * @typedef ReceivingPauseByTimeout
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 5.0.0(12)
     */
     ...
     * @param { string } host - Specified hostname.
     * @param { number } port - Specified port.
     * @returns { IpAddress[] } Returns an array of addresses.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 4.1.0(11)
     */
     ...
     * @returns { boolean | Promise<boolean> } The callback function returns a validation result of the response.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 5.0.0(12)
     */
     ...
     * @param { ArrayBuffer } incomingData - Received HTTP data.
     * @returns { number | void | Promise<void> } return the number | void | Promise<void> type data.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 5.0.0(12)
     */
     ...
     * @param { number } totalSize - The total size of the callback upload.
     * @param { number } transferredSize - The transfer speed of the callback upload.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 4.1.0(11)
     */
     ...
     * @param { number } totalSize - Total Download Size
     * @param { number } transferredSize - Downloaded Size
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 4.1.0(11)
     */
     ...
     * @param { ResponseHeaders } headers - HTTP response headers.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 4.1.0(11)
     */
     ...
     * @param { URLOrString } url - Need/no need to exclude the URL of the parameters from the proxy
     * @returns { boolean } whether the host uses a proxy, true means used, false means not used.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 4.1.0(11)
     */
    ...
    export class Request {
         ...
         * @param { URLOrString } url - The URL of the HTTP request.
         * @param { HttpMethod } [method] - The HTTP method to be used. The default value is 'GET'.
         * @param { RequestHeaders } [headers] - The HTTP request header. The default value is undefined.
         * @param { RequestContent } [content] - The content of the HTTP request. The default value is undefined.
         * @param { RequestCookies } [cookies] - The Cookie of the HTTP request.
         * @param { TransferRange | TransferRange[] } [transferRange] - HTTP transfer range.
         * @param { Configuration } [configuration] - HTTP request configuration.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 4.1.0(11)
         */
     ...
     * @param { number } maxSize - Get the maximum byte count of the callback method
     * @returns { ArrayBuffer | Promise<ArrayBuffer> } Return type could be {@link ArrayBuffer} | {@link Promise<ArrayBuffer>}
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 5.0.0(12)
     */
    ...
    export class Form {
         ...
         * @param { FormFields } fields - HTTP simple form data field
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 4.1.0(11)
         */
    ...
    export class MultipartForm {
         ...
         * @param { MultipartFormFields } fields - Representing multi-part form data.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 4.1.0(11)
         */
