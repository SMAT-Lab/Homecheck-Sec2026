...
exports.AudioPauseOrMuteCheck = void 0;
...
const multimediaInterruptSignList = [
    `@ohosSdk/api/@ohos.multimedia.media.d.ts: media.AVPlayer.on('audioOutputDeviceChangeWithInfo', @ohosSdk/api/@ohos.base.d.ts: Callback<@ohosSdk/api/@ohos.multimedia.audio.d.ts: audio.AudioStreamDeviceChangeInfo>)`,
    `@ohosSdk/api/@ohos.multimedia.audio.d.ts: audio.AudioRenderer.on('outputDeviceChangeWithInfo', @ohosSdk/api/@ohos.base.d.ts: Callback<@ohosSdk/api/@ohos.multimedia.audio.d.ts: audio.AudioStreamDeviceChangeInfo>)`
];
...
const OUTPUT_DEVICE = 'outputDeviceChangeWithInfo';
const AUDIO_OUTPUT_DEVICE = 'audioOutputDeviceChangeWithInfo';
const multimediaInterruptStmtList = new Set();
const multimediaCreateList = [];
const logger = logger_1.default.getLogger(logger_1.LOG_MODULE_TYPE.HOMECHECK, 'AudioPauseOrMuteCheck');
const gMetaData = {
    severity: 1,
...
class AudioPauseOrMuteCheck {
    ...
    getInvokeCallbackMethod(arkFile, stmt, methodName) {
        ...
        else if (methodName === 'createAudioRenderer') {
    ...
    isAudioInterruptStmt(arkFile, stmt, invoker) {
        ...
        return interruptStr === OUTPUT_DEVICE || interruptStr === AUDIO_OUTPUT_DEVICE;
    }
...
exports.AudioPauseOrMuteCheck = AudioPauseOrMuteCheck;
