...
exports.CommandExecutionCheck = void 0;
const arkanalyzer_1 = require("arkanalyzer");
const logger_1 = __importStar(require("arkanalyzer/lib/utils/logger"));
const Index_1 = require("../../../Index");
const Index_2 = require("../../../Index");
const Defects_1 = require("../../../model/Defects");
const logger = logger_1.default.getLogger(logger_1.LOG_MODULE_TYPE.HOMECHECK, 'CommandExecutionCheck');
const gMetaData = {
    severity: 1,
    ruleDocPath: '',
    description: 'Detects unsafe command execution via exec() calls.'
};
class CommandExecutionCheck {
    metaData = gMetaData;
    rule;
    defects = [];
    issues = [];
            ...
            for (const arkMethod of arkClass.getMethods()) {
                ...
                for (const stmt of cfg.getStmts()) {
                    if (stmt.getExprs().length > 0) {
                        ...
                        if (expr instanceof arkanalyzer_1.ArkStaticInvokeExpr && expr.getMethodSignature().getMethodSubSignature().getMethodName() == "exec") {
...
exports.CommandExecutionCheck = CommandExecutionCheck;
