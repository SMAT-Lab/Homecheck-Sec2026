...
exports.NoUnsafeDhKeyCheck = void 0;
...
const logger = logger_1.default.getLogger(logger_1.LOG_MODULE_TYPE.HOMECHECK, 'NoUnsafeDhKeyCheck');
const gMetaData = {
    severity: 2,
    ruleDocPath: 'docs/no-unsafe-dh-key-check.md',
    description: 'Do not use insecure DH keys, such as those with a DH modulus length less than 2048 bits.'
};
...
exports.NoUnsafeDhKeyCheck = NoUnsafeDhKeyCheck;
