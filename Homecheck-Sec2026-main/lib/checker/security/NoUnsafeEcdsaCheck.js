...
exports.NoUnsafeEcdsaCheck = void 0;
...
const logger = logger_1.default.getLogger(logger_1.LOG_MODULE_TYPE.HOMECHECK, 'NoUnsafeEcdsaCheck');
const gMetaData = {
    severity: 2,
    ruleDocPath: 'docs/no-unsafe-ecdsa-check.md',
    description: 'Do not use the insecure SHA1 digest algorithm in the ECDSA. It is recommended to use the secure ECDSA interface in the Petal Aegis SDK.'
};
...
class NoUnsafeEcdsaCheck {
    ...
    processStmt(stmts, arkClass) {
        for (let stmt of stmts) {
            ...
            if (parseStr.includes('ECC') && parseStr.includes('SHA1')) {
...
exports.NoUnsafeEcdsaCheck = NoUnsafeEcdsaCheck;
