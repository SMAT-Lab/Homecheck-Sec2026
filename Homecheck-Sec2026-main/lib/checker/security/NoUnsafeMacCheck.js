...
exports.NoUnsafeMacCheck = void 0;
...
const logger = logger_1.default.getLogger(logger_1.LOG_MODULE_TYPE.HOMECHECK, 'NoUnsafeMacCheck');
const gMetaData = {
    severity: 1,
...
const createMacSignature = `@ohosSdk/api/@ohos.security.cryptoFramework.d.ts: cryptoFramework.${lib_1.DEFAULT_ARK_CLASS_NAME}.createMac(string)`;
class NoUnsafeMacCheck {
    metaData = gMetaData;
    rule;
    defects = [];
    issues = [];
...
exports.NoUnsafeMacCheck = NoUnsafeMacCheck;
