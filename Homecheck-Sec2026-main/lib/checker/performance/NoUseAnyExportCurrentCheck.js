...
exports.NoUseAnyExportCurrentCheck = void 0;
const logger_1 = __importStar(require("arkanalyzer/lib/utils/logger"));
const Defects_1 = require("../../model/Defects");
const Matchers_1 = require("../../matcher/Matchers");
const path_1 = __importDefault(require("path"));
const logger = logger_1.default.getLogger(logger_1.LOG_MODULE_TYPE.HOMECHECK, 'NoUseAnyExportCurrentCheck');
const gMetaData = {
    severity: 3,
...
class NoUseAnyExportCurrentCheck {
    metaData = gMetaData;
    rule;
    defects = [];
    issues = [];
...
exports.NoUseAnyExportCurrentCheck = NoUseAnyExportCurrentCheck;
