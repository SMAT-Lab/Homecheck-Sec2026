...
export declare class NoFuncAsArgForReusableComponentCheck implements BaseChecker {
    ...
    private checkCustomComponentArgs;
    private checkUsedStmt;
    private isArgUseFuncInvoke;
