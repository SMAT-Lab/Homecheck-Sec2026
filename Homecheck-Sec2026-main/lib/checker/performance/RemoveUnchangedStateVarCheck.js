...
exports.RemoveUnchangedStateVarCheck = void 0;
const lib_1 = require("arkanalyzer/lib");
const logger_1 = __importStar(require("arkanalyzer/lib/utils/logger"));
const Index_1 = require("../../Index");
const ViewTreeTool_1 = require("../../utils/checker/ViewTreeTool");
const Defects_1 = require("../../model/Defects");
const logger = logger_1.default.getLogger(logger_1.LOG_MODULE_TYPE.HOMECHECK, 'RemoveUnchangedStateVarCheck');
...
class RemoveUnchangedStateVarCheck {
    metaData = gMetaData;
    rule;
    defects = [];
    issues = [];
    ...
    isStateVarModified(clazz, arkField) {
    ...
    isModifiedByCurrentClass(clazz, arkField) {
    ...
    traverseViewTree(arkFile, viewTreeRoot, arkField) {
        ...
        if (viewTreeRoot.isCustomComponent()) {
            ...
            for (let [key, value] of valuesTransferMap) {
                if (!(value instanceof lib_1.ArkField)) {
                    continue;
                }
                if (value !== arkField) {
                    continue;
...
exports.RemoveUnchangedStateVarCheck = RemoveUnchangedStateVarCheck;
