...
exports.SuggestReuseidForIfElseReusableComponentCheck = void 0;
const lib_1 = require("arkanalyzer/lib");
const logger_1 = __importStar(require("arkanalyzer/lib/utils/logger"));
const Index_1 = require("../../Index");
const Defects_1 = require("../../model/Defects");
const logger = logger_1.default.getLogger(logger_1.LOG_MODULE_TYPE.HOMECHECK, 'SuggestReuseidForIfElseReusableComponentCheck');
const gMetaData = {
    severity: 3,
...
class SuggestReuseidForIfElseReusableComponentCheck {
    metaData = gMetaData;
    rule;
    defects = [];
    issues = [];
    ...
    isComponentIncludeIfElse(childrens) {
        let flag = false;
...
exports.SuggestReuseidForIfElseReusableComponentCheck = SuggestReuseidForIfElseReusableComponentCheck;
