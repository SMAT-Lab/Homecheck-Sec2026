...
exports.NoArrayConstructorTSCheck = void 0;
const lib_1 = require("arkanalyzer/lib");
const Defects_1 = require("../../model/Defects");
const Matchers_1 = require("../../matcher/Matchers");
const DefectsList_1 = require("../../utils/common/DefectsList");
class NoArrayConstructorTSCheck {
    metaData = {
        severity: 2,
    ...
    checkGlobalArray(node, methodAst, arkFile) {
        ...
        if (isGlobalArray) {
            if (!node.arguments || node.arguments.length === 0) {
                ...
                if ((lib_1.ts.isSpreadElement(arg) && arg.getText().includes('...'))) { // 参数不是数字字面量，触发规则
                    this.createIssue(node, methodAst, arkFile);
                }
                ;
            }
    ...
    ;
    createIssue(node, methodAst, arkFile, fix = true) {
...
exports.NoArrayConstructorTSCheck = NoArrayConstructorTSCheck;
